...
urlpatterns = [
    ...
    path("fresh-stock/<int:pk>/delete", FreshStockInDeleteView.as_view()),
    ...
    path("banana-stock/<int:pk>/delete", BananaGroupStockInDeleteView.as_view()),
]
