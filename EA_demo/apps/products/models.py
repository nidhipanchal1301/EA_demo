...
class Product(TimeStampedModel):
    ...
    brand_name = models.ForeignKey(Brand, on_delete=models.CASCADE, related_name="brand_name_products", null=True, blank=True)
    category_name = models.ForeignKey(Category, on_delete=models.CASCADE, related_name="category_name_products", null=True, blank=True)
...
class StockIn(TimeStampedModel):
    ...
    product = models.ForeignKey(Product, on_delete=models.PROTECT, null=True, blank=True, related_name="product_stockin")
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.PROTECT, related_name="created_by_stockin")
    expiry_date = models.DateField(null=True, blank=True)
    inward_qty = models.IntegerField(null=True, blank=True)
    container = models.ForeignKey(Container, null=True, blank=True,on_delete=models.PROTECT, related_name="container_stockin")
